...
This capability defines requirements for direct TypeScript-to-ES2017 compilation without intermediate transpilation steps like Babel. This approach simplifies the build toolchain while targeting modern browsers.
